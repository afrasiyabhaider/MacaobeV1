...
// PRoduct Name Category
    ...
    $(document).on('submit', 'form#ProductNameCategory_add_form', function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success === true) {
                    $('div.ProductNameCategory_modal').modal('hide');
                    toastr.success(result.msg);
                    category_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
    ...
    $(document).on('click', 'button.edit_ProductNameCategory_button', function() {
        $('div.category_modal').load($(this).data('href'), function() {
            $(this).modal('show');
    ...
    $(document).on('click', 'button.delete_ProductNameCategory_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_category,
            icon: 'warning',
    ...
    //End: CRUD for PRoduct Name Category
    ...
    $(document).on('click', 'button.edit_size_button', function() {
        $('div.size_modal').load($(this).data('href'), function() {
            $(this).modal('show');
    ...
    $.ajax({
        ...
        success: function(result) {
            if (result) {
                ...
                $('#product_list_filter_category_id').html(result);
            }
        },
    });
}
function get_sub_sizes() {
    ...
    $.ajax({
        method: 'POST',
        url: '/products/get_sub_sizes',
        dataType: 'html',
        data: { cat_id: cat },
        success: function(result) {
            if (result) {
                $('#add_sub_size_id').html(result);
            }
        },
    });
}
