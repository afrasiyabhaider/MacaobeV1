		...
		<div class="box-body">
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('invoice_no', !empty($sell->return_parent->invoice_no) ? $sell->return_parent->invoice_no : null, ['class' => 'form-control','autofocus'=>'true']); !!}
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-sm-6 pull-left">
					...
					<a href='{{url("pos/return/".$sell->id)}}' class="btn btn-danger pull-left">Re-Adjust Again This</a>
					@endif
				</div>
