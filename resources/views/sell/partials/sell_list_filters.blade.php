...
<div class="col-md-3">
    <div class="form-group">
        ...
        @if(request()->session()->get('user.id') == "1")
            {!! Form::select('sell_list_filter_payment_status', ['paid' => __('lang_v1.paid'), 'due' => __('lang_v1.due'), 'partial' => __('lang_v1.partial'), 'hide' => 'Hide'], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
        @else
