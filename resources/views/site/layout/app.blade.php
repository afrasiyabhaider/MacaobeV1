...
<head>
    ...
    <meta name="description" content="MacaoBe Online Ecommerce Store">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('site_assets/vendor/fontawesome-free/css/all.min.css')}}">
</head>
<body>
                                    ...
                                    <div class="megamenu">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="banner">
                                                    <a href="#">
                                                        <img src="{{asset('site_assets/images/menu-banner.jpg')}}" alt="Menu banner" class="product-promo">
                                                    </a>
                                                </div><!-- End .banner -->
                                            </div><!-- End .col-lg-4 -->
                                        </div><!-- End .row -->
