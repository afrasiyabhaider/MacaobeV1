					...
					<div class="row">
							...
							<div class="form-group" style="width: 100% !important">
								<div class="input-group">
									...
									{!! Form::select('contact_id', 
										[], null, ['class' => 'form-control mousetrap', 'id' => 'customer_id', 'placeholder' => 'Enter Customer name / phone','onchange' => 'checkThiss(this);', 'required', 'style' => 'width: 100%;']); !!}
						...
						<div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-btn">
										<button type="button" class="btn btn-default bg-white btn-flat pos_add_quick_product" data-href="{{action('ProductController@quickAddOnly')}}" data-container=".quick_add_product_modal"><i class="fa fa-barcode" ></i></button>
				        ...
				        @endif
							...
							<div class="form-group col-md-4"  >
								<div class="input-group">
									...
									<input class="form-control" type="number" id="cust_discount" name="cust_discount"  value="0" onchange="updateDiscount(this.value);">
								</div>
							</div>
							<div class="form-group col-md-4"  >
								<div class="input-group">
...
<!-- quick product modal -->
<div class="modal fade quick_add_product_modal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" id="quick_add_product_modal"></div>
