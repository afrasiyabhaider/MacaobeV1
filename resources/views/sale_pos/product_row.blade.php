<tr class="product_row" data-row_index="{{$row_count}}">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		      	<div class="form-group col-md-12">
		      		<label>Unkown Discount</label>
		      		<input type="number" class="form-control" value="0" onChange="giveDiscount(this.value,<?=$row_count?>,false);"  id="un_discount_{{$row_count}}" name="products[{{$row_count}}][un_discount]">
		      		 
		      	</div>
		      	<div class="col-md-12">
		      		<button type="button" class="btn btn-md btn-danger" onclick="giveDiscount(10,<?=$row_count?>);"><i class="fa fa-check-circle-o" ></i> DISCOUNT : 10 </button>
		      		<button type="button" class="btn btn-md btn-info" onclick="giveDiscount(20,<?=$row_count?>);"><i class="fa fa-check-circle-o" ></i> DISCOUNT : 20 </button>
		      		<button type="button" class="btn btn-md btn-warning" onclick="giveDiscount(30,<?=$row_count?>);"><i class="fa fa-check-circle-o" ></i> DISCOUNT : 30 </button>
		      		<button type="button" class="btn btn-md btn-primary" onclick="giveDiscount(40,<?=$row_count?>);"><i class="fa fa-check-circle-o" ></i> DISCOUNT : 45 </button>
		      		<button type="button" class="btn btn-md btn-success" onclick="giveDiscount(50,<?=$row_count?>);"><i class="fa fa-check-circle-o" ></i> DISCOUNT : 50 </button>
		      	</div>
	...
	<td>
		...
		if($product->sell_line_note == "return"){
			...
			$variationId = "r".$product->variation_id ;
		}else{ 
		...
		@endif
		<input type="text" data-min="1" id="input_quantity_{{$row_count}}" class="form-control pos_quantity input_number mousetrap input_quantity" value="{{@format_quantity($product->quantity_ordered)}}" name="products[{{$row_count}}][quantity]" data-allow-overselling="@if(empty($pos_settings['allow_overselling'])){{'false'}}@else{{'true'}}@endif" 
		...
		@if($product->sell_line_note == "return") readonly="true" @endif min="1">
