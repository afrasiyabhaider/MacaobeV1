...
<section class="content-header">
    <h1>@lang('product.add_new_product') 
     <!-- ---- Row Series  | <input type="number" onchange="editPnc(this);" value="0"> -->
   </h1>
    <!-- <ol class="breadcrumb">
...
{!! Form::open(['url' => action('ProductController@bulkAddStore'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-3 @if(!session('business.enable_category')) hide @endif">
          <div class="form-group">
            ...
            {!! Form::label('category_id', __('product.category') . ':') !!}
              ...
              <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('CategoryController@createCategory', ['quick_add' => true])}}" title="@lang('brand.add_brand')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
          <div class="form-group">
            ...
            {!! Form::label('sub_category_id', __('product.sub_category') . ':') !!}
              ...
              <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('CategoryController@createSubCategory', ['quick_add' => true])}}" title="@lang('brand.add_brand')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
         ...
         <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('refference', __('product.refference') . ':') !!} @show_tooltip(__('tooltip.sku'))
            {!! Form::text('refference', null, ['class' => 'req form-control',
              'placeholder' => "refference", 'required' => 'true']); !!}
        ...
        <div class="col-sm-3  ">
          <div class="form-group">
            ...
            <div class="input-group">
              <input name="unit_price" required="true" type="text" class="req form-control" value="0" id="unit_price" onchange="changeUnitPrice(this);">
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 ">
          <div class="form-group">
            ...
            <span class="input-group-btn">
              <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="$('#btnClose').focus();console.log('dnoe');"><i class="fa fa-plus-circle"></i>Choose Size</button>
        ...
        <div class="col-sm-6 ">
          <div class="form-group">
            ...
            <span class="input-group-btn">
              <button type="button" onclick="openPrintProducts();" class="btn btn-danger btn-lg" ><i class="fa fa-plus-edit"></i>PRINT PRODUCTS</button>
              ...
              { 
                ...
                for (i = 0  ; i < obj.length; i++) {
                  rowSize++ ;
                   ...
                   html += "<div class=' col-md-3'><input onChange='setValue(this);' type='number' data-size='"+sizeId+"' data-size-name='"+size_idtext+"' data-size-sub='"+obj[i]['id']+"' data-size-sub-name='"+obj[i]['name']+"' data-color='"+$("#color_idc option:selected").val()+"' data-color-name='"+$("#color_idc option:selected").text()+"' class='form-control sizeQty'  value='1'  id='datasize_"+i+"'/></div>";
