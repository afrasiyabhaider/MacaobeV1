...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
      ...
      <a href="{{ action('Auth\LoginController@logout')}}" title="LogOff" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
    ...
    <div class="col-md-10">
      ...
      <a href="#" onclick="openPopupWindow('products');" title="Stocks" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        <strong><i class="fa fa-barcode fa-lg"></i></strong>
      </a>
      <a href="#" onclick="openPopupWindow('products/transfer');" title="Transfer Products" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        <strong><i class="fa fa-undo fa-lg"></i></strong>
      </a>
       <a href="#" onclick="openPopupWindow('pos');" title="Return Products" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        <strong><i class="fa fa-download fa-lg"></i></strong>
      </a>
       <a href="#" onclick="openPopupWindow('products/bulk_add');" title="Bulk Product Add" data-toggle="tooltip" data-placement="bottom" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
        <strong><i class="fa fa-crosshairs fa-lg"></i></strong>
      </a>
