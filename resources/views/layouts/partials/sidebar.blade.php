...
<!-- Tc UPDATE STARTS -->
        @if(auth()->user()->can('gift.create'))
          <li class="treeview {{ in_array($request->segment(1), ['roles', 'gift', 'sales-commission-agents']) ? 'active active-sub' : '' }}">
              <a href="#">
          ...
          <li class="treeview {{ in_array($request->segment(1), ['roles', 'coupon', 'sales-commission-agents']) ? 'active active-sub' : '' }}">
              <a href="#">
