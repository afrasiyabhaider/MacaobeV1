...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <li
      class="treeview {{ in_array($request->segment(1), ['roles', 'gift', 'sales-commission-agents']) ? 'active active-sub' : '' }}">
      <a href="#">
        <i class="fa fa-barcode"></i>
        <span class="title">@lang('gift.title')</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        ...
        @can( 'gift.create' )
        <li class="{{ $request->segment(1) == 'gift' ? 'active active-sub' : '' }}">
          <a href="{{action('GiftCardController@create')}}">
    ...
    <li
      class="treeview {{ in_array($request->segment(1), ['roles', 'coupon', 'sales-commission-agents']) ? 'active active-sub' : '' }}">
      <a href="#">
        <i class="fa fa-tags"></i>
        <span class="title">@lang('coupon.title')</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
      </a>
      <ul class="treeview-menu">
        @can( 'coupon.view' )
        <li class="{{ $request->segment(1) == 'coupon' ? 'active active-sub' : '' }}">
        ...
        @can( 'coupon.create' )
        <li class="{{ $request->segment(1) == 'coupon' ? 'active active-sub' : '' }}">
          <a href="{{action('CouponController@create')}}">
            <i class="fa fa-plus-circle"></i>
            <span class="title">
              @lang('coupon.gifts_add')
            </span>
          </a>
        </li>
        @endcan
    ...
    <li
      class="treeview {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories']) ? 'active active-sub' : '' }}"
      id="tour_step5">
      ...
      <ul class="treeview-menu">
        ...
        <li class="{{ $request->segment(1) == 'products' && $request->segment(2) == 'transfer' ? 'active' : '' }}"><a
            href="{{action('ProductController@transfer')}}"><i class="fa fa-random"></i>Transfer Products</a></li>
        @endif
        {{-- @can('product.create')
    ...
    {{-- Bulk Product Add --}}
    <li class="{{ $request->segment(1) == 'products' && $request->segment(2) == 'create' ? 'active' : '' }}"><a
        href="{{action('ProductController@bulkAdd')}}"><i class="fa fa-plus-circle"></i>@lang('product.add_product')</a>
    </li>
    @endcan
    @can('product.create')
    <li
      class="{{ $request->segment(1) == 'products' && $request->segment(2) == 'product_name_category' ? 'active' : '' }}">
      <a href="{{action('ProductNameCategoryController@index')}}"><i class="fa fa-plus-circle"></i>Product Name
        Series</a></li>
    @endcan
    ...
    <li class="{{ $request->segment(1) == 'categories' ? 'active' : '' }}">
      <a href="{{action('CategoryController@index')}}"><i class="fa fa-tags"></i> <span>@lang('category.categories')
        </span></a>
    </li>
    @endif
    ...
    <li class="{{ $request->segment(1) == 'sizes' ? 'active' : '' }}">
      <a href="{{action('SizeController@index')}}"><i class="fa fa-columns"></i> <span>@lang('size.category')
        </span></a>
    </li>
    @endif
    @if(auth()->user()->can('category.view') || auth()->user()->can('category.create'))
    ...
    <ul class="treeview-menu">
      ...
      <li class="{{ $request->segment(1) == 'purchases' && $request->segment(2) == null ? 'active' : '' }}"><a
          href="{{action('PurchaseController@index')}}"><i class="fa fa-list"></i>@lang('purchase.list_purchase')</a>
      </li>
      @endcan
      @can('purchase.create')
    ...
    <li
      class="treeview {{  in_array( $request->segment(1), ['sells', 'pos', 'sell-return', 'ecommerce', 'discount','monthly','daily']) ? 'active active-sub' : '' }}"
      id="tour_step7">
      ...
      <ul class="treeview-menu">
        ...
        <li class="{{ $request->segment(1) == 'sells' && $request->segment(2) == null ? 'active' : '' }}"><a
        ...
        @endif
        @can('sell.view')
            <li class="{{ $request->segment(1) == 'daily' && $request->segment(3) == null ? 'active' : '' }}"><a
                href="{{action('ReportController@dailySales')}}"><i class="fa fa-calendar"></i>
                Daily Sales
              </a></li>
            @endcan
            {{-- @can('sell.view')
    ...
    {{-- @can('sell.create')
      ...
      href="{{action('SellPosController@create')}}"><i class="fa fa-plus-circle"></i>@lang('sale.pos_sale')</a></li>
    <li class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'drafts' ? 'active' : '' }}"><a
        href="{{action('SellController@getDrafts')}}"><i class="fa fa-pencil-square"
          aria-hidden="true"></i>@lang('lang_v1.list_drafts')</a></li>

    <li class="{{ $request->segment(1) == 'sells' && $request->segment(2) == 'quotations' ? 'active' : '' }}"><a
    ...
    <li class="{{ $request->segment(1) == 'sell-return' && $request->segment(2) == null ? 'active' : '' }}"><a
        href="{{action('SellReturnController@index')}}"><i class="fa fa-undo"></i>@lang('lang_v1.list_sell_return')</a>
    </li>
    @endcan
    ...
    <li class="{{ $request->segment(1) == 'discount' ? 'active' : '' }}"><a
        href="{{action('DiscountController@index')}}"><i class="fa fa-percent"></i>@lang('lang_v1.discounts')</a></li>
    @endcan
    ...
    <li class="treeview {{ $request->segment(1) == 'account' ? 'active active-sub' : '' }}">
      ...
      <ul class="treeview-menu">
        <li class="{{ $request->segment(1) == 'account' && $request->segment(2) == 'account' ? 'active' : '' }}"><a
        ...
        <li class="{{ $request->segment(1) == 'account' && $request->segment(2) == 'cash-flow' ? 'active' : '' }}"><a
            href="{{action('AccountController@cashFlow')}}"><i class="fa fa-exchange"></i>@lang('lang_v1.cash_flow')</a>
        </li>
    ...
    <li class="treeview {{  in_array( $request->segment(1), ['reports']) ? 'active active-sub' : '' }}" id="tour_step8">
      ...
      <ul class="treeview-menu">
        @can('stock_report.view')
        <li class="{{ $request->segment(2) == 'supplier-report' ? 'active' : '' }}"><a
            href="{{action('ReportController@supplier_report')}}"><i class="fa fa-user" aria-hidden="true"></i>
            Supplier Report
          </a></li>
        @endcan
        @can('stock_report.view')
        <li class="{{ $request->segment(2) == 'subcategory-report' ? 'active' : '' }}"><a
            href="{{action('ReportController@sub_category_report')}}"><i class="fa fa-dropbox" aria-hidden="true"></i>
            Sub-Category Report
          </a></li>
        @endcan
        @can('stock_report.view')
        <li class="{{ $request->segment(2) == 'product-first-report' ? 'active' : '' }}"><a
            href="{{action('ReportController@product_first_report')}}"><i class="fa fa-shopping-bag"
              aria-hidden="true"></i>
            Product Report N/S
          </a></li>
        @endcan
        ...
        <li class="{{ $request->segment(2) == 'product-second-report' ? 'active' : '' }}"><a
            href="{{action('ReportController@product_first_report')}}"><i class="fa fa-cart-plus"
              aria-hidden="true"></i>
            Product Report W/S
          </a></li>
        @endcan
        ...
        {{-- @can('tax_report.view')
          ...
          href="{{action('ReportController@getTaxReport')}}"><i class="fa fa-tumblr"
            aria-hidden="true"></i>@lang('report.tax_report')</a>
    </li>
    @endcan --}}
    ...
    <li class="{{ $request->segment(2) == 'expense-report' ? 'active' : '' }}"><a
        href="{{action('ReportController@getExpenseReport')}}"><i class="fa fa-search-minus"
    ...
    <li
      class="treeview @if( in_array($request->segment(1), ['business', 'tax-rates', 'barcodes', 'invoice-schemes', 'business-location', 'invoice-layouts', 'printers', 'subscription']) || in_array($request->segment(2), ['tables', 'modifiers']) ) {{'active active-sub'}} @endif">
