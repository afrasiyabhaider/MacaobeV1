<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	{{ config('app.name', 'ultimatePOS') }} - V{{config('author.app_version')}} | Copyright &copy; {{ date('Y') }} All rights reserved. Developed By <a href="http://fb.com/wearespecialists" target="_blank">WeareSpecialists</a>
    </small>
